...
# Setup script for centralized-data-aggregation
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-data-aggregation development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-data-aggregation_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-data-aggregation_CLEAN
...
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-data-aggregation_db
DATABASE_USERNAME=centralized-data-aggregation_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-data-aggregation</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-data-aggregation</name>
    <description>Centralized Dashboard centralized-data-aggregation Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-data-aggregation_db
      POSTGRES_USER: centralized-data-aggregation_user
