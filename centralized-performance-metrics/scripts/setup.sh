...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-performance-metrics_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-performance-metrics_CLEAN
