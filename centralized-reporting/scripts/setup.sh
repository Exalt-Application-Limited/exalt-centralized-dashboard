...
# Setup script for centralized-reporting
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-reporting development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-reporting_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-reporting_CLEAN
...
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-reporting_db
DATABASE_USERNAME=centralized-reporting_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-reporting</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-reporting</name>
    <description>Centralized Dashboard centralized-reporting Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-reporting_db
      POSTGRES_USER: centralized-reporting_user
...
# Build the service
echo "Building centralized-reporting..."
