...
# Setup script for centralized-dashboard-shared
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-dashboard-shared development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-dashboard-shared_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-dashboard-shared_CLEAN
...
centralized-dashboard-shared=centralized-dashboard-shared
SERVICE_PORT=8080
SPRING_PROFILES_ACTIVE=local
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-dashboard-shared_db
DATABASE_USERNAME=centralized-dashboard-shared_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-dashboard-shared</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-dashboard-shared</name>
    <description>Centralized Dashboard centralized-dashboard-shared Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-dashboard-shared_db
      POSTGRES_USER: centralized-dashboard-shared_user
...
# Build the service
echo "Building centralized-dashboard-shared..."
