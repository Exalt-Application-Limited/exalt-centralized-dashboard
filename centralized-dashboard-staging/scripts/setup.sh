...
# Setup script for centralized-dashboard-staging
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-dashboard-staging development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-dashboard-staging_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-dashboard-staging_CLEAN
...
centralized-dashboard-staging=centralized-dashboard-staging
SERVICE_PORT=8080
SPRING_PROFILES_ACTIVE=local
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-dashboard-staging_db
DATABASE_USERNAME=centralized-dashboard-staging_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-dashboard-staging</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-dashboard-staging</name>
    <description>Centralized Dashboard centralized-dashboard-staging Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-dashboard-staging_db
      POSTGRES_USER: centralized-dashboard-staging_user
...
# Build the service
echo "Building centralized-dashboard-staging..."
