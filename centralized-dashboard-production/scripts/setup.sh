...
# Setup script for centralized-dashboard-production
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-dashboard-production development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-dashboard-production_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-dashboard-production_CLEAN
...
centralized-dashboard-production=centralized-dashboard-production
SERVICE_PORT=8080
SPRING_PROFILES_ACTIVE=local
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-dashboard-production_db
DATABASE_USERNAME=centralized-dashboard-production_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-dashboard-production</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-dashboard-production</name>
    <description>Centralized Dashboard centralized-dashboard-production Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-dashboard-production_db
      POSTGRES_USER: centralized-dashboard-production_user
...
# Build the service
echo "Building centralized-dashboard-production..."
