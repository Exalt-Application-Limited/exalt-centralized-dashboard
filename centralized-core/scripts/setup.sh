...
# Setup script for centralized-core
# This script sets up the development environment for the Java service

set -e

echo "Setting up centralized-core development environment..."
...
mkdir -p src/main/java/com/exalt/centralizeddashboard/centralized-core_CLEAN
mkdir -p src/main/resources
mkdir -p src/test/java/com/exalt/centralizeddashboard/centralized-core_CLEAN
...
centralized-core=centralized-core
SERVICE_PORT=8080
SPRING_PROFILES_ACTIVE=local
DATABASE_URL=jdbc:postgresql://localhost:5432/centralized-core_db
DATABASE_USERNAME=centralized-core_user
...
<project xmlns="http://maven.apache.org/POM/4.0.0"
    ...
    <artifactId>centralized-core</artifactId>
    <version>1.0.0-SNAPSHOT</version>
    <packaging>jar</packaging>
    
    <name>centralized-core</name>
    <description>Centralized Dashboard centralized-core Service</description>
...
services:
  postgres:
    ...
    environment:
      POSTGRES_DB: centralized-core_db
      POSTGRES_USER: centralized-core_user
...
# Build the service
echo "Building centralized-core..."
